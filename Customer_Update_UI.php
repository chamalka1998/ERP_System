                ...
                <div class="container-fluid">
                    ...
                    <form action="Customer_Update.php" method="POST">
                        ...
                        <?php
                                    ...
                                    $sql_query = "SELECT * FROM customer WHERE id='$customer_id'";
                                    ...
                                    if ( $sql_query_result->num_rows>0 ) {
                                        ...
                                        $contact_number = $data_row[ 'contact_no' ];
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="middle_name" name="middle_name"
                                    placeholder="Middle name" value="<?php echo $middle_name;?>">
                            </div>
                            <!-- last_name End -->
                    ...
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" id="contact_number" name="contact_number"
                                    placeholder="Contact number" value="<?php echo $contact_number;?>">
                            </div>
                        </div>
                        <!-- contact_number End -->
