            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Invoice report</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table id="dataTable" class="display nowrap" style="width:100%">
                                    ...
                                    $sql_query = "SELECT * FROM invoice JOIN customer ON invoice.customer = customer.id";
                                    ...
                                    if ($sql_query_result->num_rows>0) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $data_row['customer']; ?></td>
                                            <td><?php echo $data_row['district']; ?></td>
                                            <td><?php echo $data_row['item_count']; ?></td>
